...
public class MyApplication extends Application{
   ...
   //设备ID，JSON路径
    ...
    private String path_DeleteDevice;
    private String path_getScenes;
    private String path_changeScenes;
...
//    	MyId = "abc1234"; 
    	...
    	joinFamilyStatus("http://ZONENAME/api/TJudge.php?tid=" + MyId);
    	path_forecast = "https://api.caiyunapp.com/v2/YOURVALUE/";
    	path_getHTCP = "http://ZONENAME/api/TGetData.php?tid=";
    	path_setHTCP = "http://ZONENAME/api/TSetData.php?Tid=";
    	path_AddDevice = "http://ZONENAME/api/AddDevice.php?uidORtid=";
    	path_getScenes = "http://ZONENAME/GetModel.php?tid=";
    	path_changeScenes = "http://ZONENAME/api/ChangeModel.php?tid=";
    	setPath_DeleteDevice("http://ZONENAME/api/DeleteDevice.php?uidORtid=");
        latitude=36.001347;
